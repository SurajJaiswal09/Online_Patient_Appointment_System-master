...
function Footer() {
  ...
  <nav className="grid grid-flow-col gap-4">
    <Link to='aboutus' smooth={true} duration={500} offset={-100} className="cursor-pointer">
      <span className="link link-hover">About us</span>
    </Link>
    <Link to='contactus' smooth={true} duration={500} offset={-100} className="cursor-pointer">
  ...
  <aside>
    <p>Copyright © 2024 - All right reserved by Rohit Soni Developer</p>
  </aside>
</footer>
    </div>
